...
import { 
  BookOpen, Bell, Lock, HelpCircle, LogOut, ChevronRight
} from 'lucide-react';
    ...
    <div className="page-container">
      <div className="flex flex-col items-center mt-4 mb-6">
        <div className="w-16 h-16 bg-purple-200 rounded-full mb-3 flex items-center justify-center">
          <div className="text-purple-800 font-bold text-xl">SW</div>
        </div>
        ...
        <div className="flex gap-4 mt-3">
          <button 
            className="bg-purple-200 text-purple-800 px-4 py-1.5 rounded-full text-sm font-medium"
            onClick={() => toast({
      ...
      <div className="flex mb-6 justify-between text-center">
        <div className="flex-1 bg-mood-peach rounded-2xl p-3">
          <p className="text-sm text-gray-600">Streak</p>
          <p className="font-bold text-xl">7 days</p>
        </div>
        <div className="flex-1 bg-mood-peach rounded-2xl p-3 mx-2">
      ...
      <div className="bg-wellness-orange rounded-2xl p-4 mb-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between p-3 border-b">
          <div className="flex items-center">
            <BookOpen size={20} className="mr-3 text-gray-700" />
        ...
        <div className="flex items-center justify-between p-3 border-b">
          <div className="flex items-center">
            <Bell size={20} className="mr-3 text-gray-700" />
          ...
          <div>
            <button 
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                notificationsEnabled ? 'bg-purple-500' : 'bg-gray-200'
              }`}
            >
              <span
        ...
        <div className="flex items-center justify-between p-3 border-b">
          <div className="flex items-center">
            <Lock size={20} className="mr-3 text-gray-700" />
